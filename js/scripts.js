...
//     // counter[slideIndex-1].innerHTML = slideIndex + ' ' + '/' + ' ' + slides.length;
//     counter[slideIndex - 1].innerHTML = `<span style="color: var(--primary-color); font-weight: bold;">${slideIndex}</span> / ${slides.length}`;
